...
sudo consul agent -ui=false -bind=192.168.100.5 -client=0.0.0.0 -data-dir=. -node=nodo_3 -retry-join="192.168.100.3" -retry-join="192.168.100.5" -retry-join="192.168.100.4" &
